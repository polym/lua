...
arg[0] = '/heka/build/ep_base/Build/lua_sandbox/ep_base/Source/lua-5_1_5/test/echo.lua'
table.remove(arg, 1)
return assert(loadfile '/heka/build/ep_base/Build/lua_sandbox/ep_base/Source/lua-5_1_5/test/echo.lua')(unpack(arg))
